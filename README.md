...
A wall-anchored garage workbench for unfinished stud walls — designed with [Claude Code](https://claude.com/product/claude-code), built from ~$205 in lumber, no glue.
...
| Resource | What it is |
|----------|------------|
| **[Interactive 3D build guide](https://dpappo.github.io/workbench/)** | Step through all 15 build steps in 3D — orbit, zoom, keyboard navigation, cut-plan diagrams |
...
Roughly **$161** for the bench itself, **~$205** with pegboard (prices from a Canadian big-box run; your mileage may vary).
...
The geometry, fastener logic, kerf-aware cut list, and teaching copy were developed in conversation with **Claude Code** — iterating on stability, knee clearance under the shelf, and beginner-friendly explanations (toe-screws, doubled members, why floors slope). The 3D guide visualizes each step so you can see what you're building before you cut.
